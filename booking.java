...
public class booking extends javax.swing.JFrame{
    ...
    public void connect()
    {
        try {
            ...
            try {
                c=DriverManager.getConnection("jdbc:mysql://localhost/busbooking?useSSL=false","root","system");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ONLINE BUS TICKET BOOKING ");
        ...
        c1.setModel(new javax.swing.DefaultComboBoxModel<String>(new String[] { "Coimbatore", "Chennai", "Mysore", "Bangalore", "Kochi", "Thirssur","Madurai"}));

        c2.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        c2.setModel(new javax.swing.DefaultComboBoxModel<String>(new String[] { "Coimbatore", "Chennai", "Mysore", "Bangalore", "Kochi", "Thirssur","Madurai"}));

        c3.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        c3.setModel(new javax.swing.DefaultComboBoxModel<String>(new String[] { "6:00 am", "8:00 am", "12:00 pm", "2:00 pm", "5:00 pm", "7:00 pm" }));
    ...
    private void b1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        String s2=(String)c2.getSelectedItem().toString();
        String s3=(String)t1.getText();
        String s4=(String)c3.getSelectedItem().toString();
        ...
        c3.setSelectedItem("6:00 am");
        }
        else
        {
        t3.setText(Integer.toString((int) c));
    ...
    private void b3ActionPerformed(java.awt.event.ActionEvent evt) {
        try
        {
            ...
            p.setString(5,s4);
            p.setString(6,s5);
            p.setDouble(7, Double.parseDouble(s6));
